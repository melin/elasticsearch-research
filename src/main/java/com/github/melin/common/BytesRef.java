 ...
 * 
 * <p>
 * <b>Important note:</b> Unless otherwise noted, Lucene uses this class to
 * represent terms that are encoded as <b>UTF8</b> bytes in the index. To
 * convert them to a Java {@link String} (which is UTF16), use
 * {@link #utf8ToString}. Using code like
 * {@code new String(bytes, offset, length)} to do this is <b>wrong</b>, as it
 * does not respect the correct character set and may return wrong results
...
public final class BytesRef implements Comparable<BytesRef>, Cloneable {
	 ...
	 * 
	 * @param text
	 *            This must be well-formed unicode text, with no unpaired
	 *            surrogates.
	 */
	 ...
	 * <p>
	 * NOTE: if this would exceed the array size, this method creates a new
	 * reference array.
	 */
	 ...
	 * <code>other</code>
	 * <p>
	 * The returned BytesRef will have a length of other.length and an offset of
	 * zero.
	 */
